// The main javascript file for Datatable-OData-Wrapper.
// IMPORTANT:
...
$(function () {
  ...
  if (window['cot_app']) {
    const app = new cot_app("Datatable-OData-Wrapper");

    app.setBreadcrumb([
      {"name": "Datatable-OData-Wrapper", "link": "#"}
    ]);

    app.render();
  }

  form.render($('.Datatable-OData-Wrapper_container'));
});
